...
Sports Edge: slash-only / explicit (`/thermo-nuclear-review`). Run before merge. Do not auto-invoke during implementation. Follow this rubric; do not paste it into `AGENTS.md` or always-on rules.
