-- Migration: deduplicate the daily serving view by schedule date and matchup.
--
-- Historical syncs may have inserted multiple Supabase games for the same
-- league/date/home/away tuple. Keep the base rows intact, but expose only the
-- best row per matchup to portfolio clients.
